  ...
  return (
    <div className="min-h-screen flex flex-col p-8 pt-6">
      ...
      <div className="flex flex-col items-center justify-center mb-10">
        ...
        <h1 className="text-4xl font-black tracking-tighter text-center text-white">Stardy</h1>
        <p className="text-white/60 text-base mt-2 text-center font-medium">Ready to level up your skills?</p>
      </div>
      ...
      <div className="flex flex-col gap-5 w-full">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm font-medium px-1 text-slate-500">Email</label>
          <div className="relative flex items-center">
            <span className="material-symbols-outlined absolute left-4 text-slate-400">mail</span>
            <input 
              className="w-full h-14 pl-12 pr-4 rounded-full border border-slate-200 bg-slate-50 text-base text-slate-900 focus:border-primary focus:ring-0 outline-none transition-all placeholder:text-slate-300" 
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="relative flex items-center">
            ...
            <input 
              className="w-full h-14 pl-12 pr-12 rounded-full border border-slate-200 bg-slate-50 text-base text-slate-900 focus:border-primary focus:ring-0 outline-none transition-all placeholder:text-slate-300" 
              placeholder="••••••••" 
              type="password" 
            />
