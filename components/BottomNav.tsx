...
const BottomNav: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 max-w-[480px] mx-auto bg-black border-t border-white/10 px-4 pt-3 pb-8 flex items-center justify-between z-50">
      {navItems.map((item) => (
        <button
          key={item.path}
